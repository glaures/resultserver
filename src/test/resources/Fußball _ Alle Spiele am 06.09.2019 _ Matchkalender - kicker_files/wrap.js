(function () {
  ...
  var Caspr=function(u,t,l,f,e){this.CONSTANTS={MATCHING_STYLE_1:1,MATCHING_STYLE_2:2,MATCHING_STYLE_3:3,MATCHING_STYLE_4:4},this.log_sample=void 0===u.ls||u.ls,this.rules=("string"==typeof u&&(u=JSON.parse(atob(u))),u&&u.m?u.m:[]),this.masterReset=!0,"rs"in u&&(this.masterReset=u.rs),this.frames=[],this.cajsPresent=!1,this.tagSource=t||"",this.trackers=["iframe","object","a"],this.hasBeenUndone=!1,this.adserverDomain="/* @echo DOMAIN */",this.submitEndpoint="/log",this.targetId=null,this.prefixedTpid=l&&""!==l?l:null,this.submitted=!1,this.doneWithSandbox=!1,this.version=u.v?u.v:0,this.window=window,this.replaceWithHTML=null,this.isDfpOnPageIntegration=!1,this.isForcedSandboxing=!1,this.inAppSuccessCallback=null,this.devMode=0,this.supportLandingPageBlocking=!1,this.isAst=!1,this.isIEorEdgeorFF=window.navigator.userAgent.match(/(Trident\/7.0)|(edge|Firefox)/i);var n=.005,c=!1;e&&(this.adserverDomain=e),this.wrapper=f,this.errors=[],this.blockingData=null,this.do_undo=void 0===u.du||!!u.du,this.replace=void 0!==u.re?unescape(u.re):"",this.backupFunctions={},this.targetId=f&&f.uniqueHash&&0<f.uniqueHash.length?f.uniqueHash:l,this.dom={findings:[],parentHTML:"",getRootElement:function(t){return c?document.body:document.getElementById(t.targetId)},walkTheDOM:function(t,e){for(e(t),t=t.firstChild;t;)this.walkTheDOM(t,e),t=t.nextSibling;return this.parentHTML},traverseAd:function(t){if(t){var i=this;return this.parentHTML=t.outerHTML,this.walkTheDOM(t,function(t){if(1==t.nodeType){if(t.contentWindow)try{var e=t.contentWindow.document.getElementsByTagName("html")[0].innerHTML;i.parentHTML=i.parentHTML.replace(t.outerHTML,"<head></head><body></body>"==e?t.outerHTML:t.outerHTML.replace("</iframe>",e+"</iframe>"))}catch(t){}}else 3===t.nodeType&&t.data.trim()})}}},this.getTopFrameParent=function(){var o=function(t,e){try{for(var i=t.contentWindow.document.getElementsByTagName("iframe"),r=0;r<i.length;r++){var n=i[r];if(n==e)return!0;if(o(n,e))return!0}return!1}catch(t){return!1}};try{if(frameElement){for(var t=window.top.document.getElementsByTagName("iframe"),e=0;e<t.length;e++){if(t[e]==frameElement)return t[e];if(o(t[e],frameElement))return t[e]}return!1}return!1}catch(t){return!1}},this.findContextForTpid=function(i,t){var e,r=function(){var t=0<Object.keys(window[i]).length?Object.keys(window[i]):null;if(!t)return null;for(var e=0;e<t.length;e++)if("tpid"!=t[e])return t[e];return null}(window);if(!r)throw Error("Unable to find confiant context object. Please contact support@confiant.com.");return e=window[i][r],window[i][t]=e},this.wrapper={PAYLOAD_KEY:"d",TAG_KEY:"t",_data:{},augmentRequest:function(t){return(t=t||{}).wr=this._data.wr,t.wh=this._data.wh,t.wd=this._data.wd,t},init:function(t){var e=t.findContextForTpid(l,"%%TP_IDENTIFIER%%");e.u=1*new Date,this._data=e[this.PAYLOAD_KEY],t.tagSource=e[this.TAG_KEY],e.isE&&(t.tagSource=unescape(t.tagSource),t.isDfpOnPageIntegration=!0),this._tag=t.tagSource,t.isSafeFrame=e.isSfrm,t.isSandboxedSafeframe=e.isSfrm&&e.isSb,t.isForcedSandboxing=e.isFSb,t.inAppSuccessCallback=e.successCallback,t.devMode=e.devMode||0}},this.creativeWrapper={init:function(t){var e=t.findContextForTpid(f.uniqueHash,f.tpIdentifier);e.u=1*new Date,t.tagSource=e.t,e.isE&&(t.tagSource=unescape(t.tagSource),t.isDfpOnPageIntegration=!0);var i=f.uniqueHash;"function"!=typeof e.cb&&(e.cb=null),t.cb=e.cb?e.cb:function(){try{window.top.postMessage("cb"+i+btoa(JSON.stringify(Array.prototype.slice.call(arguments))),"*")}catch(t){window.parent.postMessage("cb"+i+btoa(JSON.stringify(Array.prototype.slice.call(arguments))),"*")}},t.id=e.id?e.id:null,t.isSafeFrame=e.isSfrm,t.isSandboxedSafeframe=e.isSfrm&&e.isSb,t.isForcedSandboxing=e.isFSb,t.inAppSuccessCallback=e.successCallback,t.devMode=e.devMode||0,t.shouldSupportLandingPageBlocking=e.isAST||2==e.devMode,t.isAst=e.isAST}};var i,r,o=["ZS1wbGFubmluZy5uZXQ=","Y29uZmlhbnRfdGVzdF8xMjMxMDE=","aW5kZXhPZg==","aW1nLnR1cm5jZG4uY29t","cG0tbm90aWZpY2F0aW9ucy5jb20=","c3RvcmFnZS5nb29nbGVhcGlzLmNvbQ=="];i=o,r=363,function(t){for(;--t;)i["push"](i["shift"]())}(++r);var h,s=function(t){var e=o[t-=0];void 0===s["initialized"]&&(function(){var e;try{e=Function("return (function() "+'{}.constructor("return this")( )'+");")()}catch(t){e=window}var a="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";e["atob"]||(e["atob"]=function(t){for(var e,i,r=(t+"")["replace"](/=+$/,""),n=0,o=0,s="";i=r["charAt"](o++);~i&&(e=n%4?64*e+i:i,n++%4)?s+=String["fromCharCode"](255&e>>(-2*n&6)):0)i=a["indexOf"](i);return s})}(),s["base64DecodeUnicode"]=function(t){for(var e=atob(t),i=[],r=0,n=e["length"];r<n;r++)i+="%"+("00"+e["charCodeAt"](r)["toString"](16))["slice"](-2);return decodeURIComponent(i)},s["data"]={},s["initialized"]=!0);var i=s["data"][t];return void 0===i?(e=s["base64DecodeUnicode"](e),s["data"][t]=e):e=i,e},a={},d=s("0x0"),p=s("0x1"),g=s("0x2"),m=s("0x3"),w=s("0x4");function v(){var t,e="undefined"!=typeof InstallTrigger;return(/constructor/i.test(window.HTMLElement)||""+(!window["safari"]||"undefined"!=typeof safari&&safari.pushNotification)=="[object SafariRemoteNotification]")&&(t="safari"),e&&(t="firefox"),!(!window.chrome||!window.chrome.webstore&&!window.chrome.runtime)&&(t="chrome"),t||(-1<navigator.userAgent.indexOf("Safari")&&(t="safari"),-1<navigator.userAgent.indexOf("FireFox")&&(t="firefox"),-1<navigator.userAgent.indexOf("Chrome")&&-1==navigator.userAgent.indexOf("Edge")&&(t="chrome")),t}function b(t,e){return t.test(e)}if(a[d]=.05,a[p]=.05,a[g]=.05,a[m]=.05,a[w]=1,this.prebidIeAndEdgeFix=function(){try{var d=document,h=this;d.open=(c=document.open,function(t,e){var i,r,n;try{n=h.findContextForTpid(i=f.uniqueHash,r=f.tpIdentifier)}catch(t){}var o=c.call(this,t,e);try{if(delete d.write,delete d.open,i&&r&&n){n.t="\x3c!-- tag --\x3e";var s="var Caspr = "+Caspr+";\n",a="new Caspr("+JSON.stringify(u)+', null, "'+l+'",'+'{"uniqueHash":"'+i+'","tpIdentifier":"'+r+'"},'+'"'+h.adserverDomain+'")';o.defaultView[i]={},o.defaultView[i]["tpId"]=r,o.defaultView[i][r]=JSON.parse(JSON.stringify(n)),o.defaultView.eval(s),o.defaultView.eval(a)}}catch(t){console.error(t)}return o})}catch(t){console.error(t)}var c},this.init=function(){var t,e=this,i=!f||f&&!f.tpIdentifier;i&&this.wrapper.init(this),i||this.creativeWrapper.init(this),this.isIEorEdgeorFF&&this.prebidIeAndEdgeFix(),this.casprize(!1),this.tagSource&&(n=function(t){for(var e in a){var i=e;if(-1<t[s("0x5")](i))return a[e]}return n}(this.tagSource));try{var r=this.wrapper?this.wrapper.uniqueHash:this.targetId;c="grSCdeFNjRM2qJzjPar8-rG_Vro"===r||"mOinGM9MTu5v-Lto835XLhlrSPY"===r||"2"==this.devMode}catch(t){}t=c?this.tagSource:"<div id='"+this.targetId+"' class='ad-container-"+this.targetId+"'>"+this.tagSource+"</div>",this.isSafeFrame?this.createPatchFunction(this.patchArguments[0],this.patchArguments[1],this.patchArguments[2])([this.tagSource],this.isSafeFrame):document.write(t),this.postAPIEvent("confiantSlotRenderEnded"),window.addEventListener("load",function(){if(e.do_undo){if(window.Caspr=void 0,caspr=void 0,e.hasBeenUndone)return;e.casprize(!0),e.hasBeenUndone=!0}if(!e.submitted&&e.log_sample&&Math.random()<=n){var t=e.dom.traverseAd(e.dom.getRootElement(e));e.blockingData={html:t||null,ar:"",r:!1,oi:null,ot:null,tag:e.tagSource,v:e.version},e.submitFindings()}})},this.setRules=function(t){this.rules="object"==typeof t?t:[t]},this.getRules=function(){return this.rules},this.submitFindings=function(t){if("undefined"!=typeof XMLHttpRequest&&!this.submitted){this.submitted=!0;var e=3==this.devMode,i=window.sf_||window.$sf?document.referrer:window.location.href,r={};r.u=i,r.logs=this.errors,this.blockingData&&(r.bd=this.blockingData),this.prefixedTpid&&(r.uh=this.prefixedTpid),r.id=this.id,(r=this.wrapper.augmentRequest(r)).tt="w",r.tt="t";var n=this.adserverDomain+this.submitEndpoint;try{var o=null;try{o=btoa(JSON.stringify(r))}catch(t){o=JSON.stringify(r)}if(!e)if(t){var s=btoa(JSON.stringify({sendUrl:n,payload:o,slotId:this.id,replaceWith:this.replaceWithHTML}));try{window.top.postMessage("comm"+this.targetId+s,"*")}catch(t){window.parent.postMessage("comm"+this.targetId+s,"*")}}else{var a=new XMLHttpRequest;a.onreadystatechange=function(){},a.open("POST",n,!1),a.send(o)}r.bd.ot&&this.cb&&this.cb(r.bd.ot,r.bd.oi,this.blockingData.r,this.wrapper.uniqueHash,this.wrapper.tpIdentifier,this.id)}catch(t){console.error("Confiant: Failed to log",""+t)}}},this.postAPIEvent=function(e){var t=(""+(new Date).getTime()).split("").reverse().join(""),i=0,r=btoa(Math.ceil(1e4*Math.random())+"cOmM"+t),n={propertyId:this.wrapper?this.wrapper.uniqueHash:this.targetId,tagId:this.wrapper?this.wrapper.tpIdentifier:"",impressionData:this.id},o=function(t){t.data&&t.data.id===r&&(i=100,window.removeEventListener("message",o))},s=function(t){3<=i||(window.top.postMessage({eventType:e,details:n,id:r},"*"),i++,t&&setTimeout(s,500))};window.addEventListener("message",o),s(this.isDfpOnPageIntegration)},this.casprize=function(e,t){t=t||this;var i=this;try{var r={},n=!1,o=!1,s="OX",a=i.tagSource||"";try{r=window.top,o=-1!=a.indexOf(s),n=!!(a.match(/(adb.auction\()|(listenAdFromPrebid)|(listenForAdFromPrebid)|(AdGlare)|(sonobi.com)|(roimediaconsultants.com)|(adnxs\.com\/mediation)|(prebid-universal-creative)|(smartadserver.com)|(gumgum.com)|(adtelligent.com)/)||r.rubicontag||r[s]),o=o||n&&!!r[s]}catch(t){}e||t.window!==window?e&&i.unpatchNode():(n&&i.patchNodeMethod("appendChild"),o&&i.patchNodeMethod("replaceChild"));for(var d=0;d<this.rules.length;d++){var h,c;if(e?(0<i.devMode&&console.info("Un-patching!"),c=this.backupFunctions,h=t.window,this.doneWithSandbox=!0):(0<i.devMode&&console.info("Patching!"),h=this.backupFunctions,c=t.window),void 0===this.rules[d].f&&(this.rules[d].f="write"),""!=this.rules[d].f){if(void 0===this.rules[d].h)this.rules[d].h="document";else if(""==this.rules[d].h)continue;if("window"!=this.rules[d].h?(e||h[this.rules[d].h]||(h[this.rules[d].h]={}),h[this.rules[d].h][this.rules[d].f]=c[this.rules[d].h][this.rules[d].f]):(e||h[this.rules[d].h]||(h[this.rules[d].h]={}),e?h[this.rules[d].f]=c[this.rules[d].h][this.rules[d].f]:h[this.rules[d].h][this.rules[d].f]=c[this.rules[d].f]),e)this.hasBeenUndone=!0;else if(this.patch(this.rules[d],d,t),("write"==this.rules[d].f||"writeln"==this.rules[d].f)&&"document"==this.rules[d].h){var u="write"==this.rules[d].f?"writeln":"write",l={r:this.rules[d].r,h:this.rules[d].h,f:u};e||h[this.rules[d].h]||(h[this.rules[d].h]={}),h[this.rules[d].h][u]=c[this.rules[d].h][u],this.patchArguments=[l,d,t],this.patch(l,d,t)}}}}catch(t){console.error("ERROR",t),e||this.casprize(!0)}},this._complete_blocking=function(t,e,i,r,n,o){if(!e.r[i]||!e.r[i].l[r])return t;var s="",a=null;a=this.dom.getRootElement(this),s=this.dom.traverseAd(a);var d=e.r[i].l[r],h=!1;return"rs"in d&&(h=d.rs),this.masterReset||(h=!1),this.blockingData={html:(s=s+"\n\x3c!-- violation detected --\x3e\n"+t)||null,ar:o,r:h,oi:!!d.oi&&d.oi,ot:!!d.ot&&d.ot,tag:this.tagSource,v:this.version},this.replaceWithHTML="re"in d&&""!==d.re?d.re:this.replace,this.submitFindings(n),h&&!d.isSb&&(a&&a.remove&&!c&&a.remove(),this.casprize(!0),t=this.replaceWithHTML),{replaceWithHtml:t,shouldBlock:h}},this._is_match=function(t,i,e,r){if(!i)return!1;t instanceof Array||(t=[t]);var n,o,s,a,d="",h=RegExp(r?"[^a-zA-Z0-9-_]":"[^a-zA-Z0-9]"),c=-1,u=-1,l=!1,f=function(t){var e=i.charAt(t);return""==e||h.test(e)};if(e===this.CONSTANTS.MATCHING_STYLE_4)return RegExp(d=t[0]).test(i);for(var p=0;p<t.length;p++){if(u=i.indexOf(d=t[p],c),1==this.devMode)return!0;if(!(l=-1<u))return!1;if(n=u-1,o=u+d.length,e===this.CONSTANTS.MATCHING_STYLE_2?l=l&&(f(n)||(s=i,a=n,!(!this.shouldSupportLandingPageBlocking||!r)&&(0<=a-3?"F"==s[a]&&"2"==s[a-1]&&"%"==s[a-2]:void 0)))&&f(o):e===this.CONSTANTS.MATCHING_STYLE_1&&(l=l&&f(o)),!l)return!1;c=o}return!0},this.patchNodeMethod=function(t){var s=this,i=Node.prototype[t];Node.prototype[t]=function(n){var t=n.src||"";n&&"IFRAME"===n.tagName&&(t.indexOf("https://")<0&&t.indexOf("http://")<0||0<=t.indexOf(window.location.hostname))&&!s.isIEorEdgeorFF&&(n.onload=function(){try{n.contentWindow&&s.casprize(!1,n.contentWindow)}catch(t){}});var o,e=i.apply(this,arguments);try{n.contentDocument&&(n.contentDocument.open=(o=n.contentDocument.open,function(t,e){var i=o.call(this,t,e);try{s.isIEorEdgeorFF&&(delete n.contentDocument.write,delete n.contentDocument.open,s.casprize(!1,n.contentWindow))}catch(t){console.error(t)}try{var r=window.top.confiant;r&&r.services().onNestedFrameCreation&&r.services().onNestedFrameCreation(n)}catch(t){}return i}))}catch(t){console.error(t)}return e},Node.__cspr__=Node.__cspr__||[],Node.__cspr__.push([t,i])},this.unpatchNode=function(){if(Node.__cspr__){for(var t=Node.__cspr__,e=t.length,i=0;i<e;i++)Node.prototype[t[i][0]]=t[i][1];delete Node.__cspr__}},this.createPatchFunction=function(v,t,b){var S=this;return function(t,e){try{var i={},r=e?t:b.window[v.h][v.f].arguments;if(!r||0===r.length)return;if("setTimeout"==v.f||"setInterval"==v.f||"onload"==v.f)"onload"!=v.f&&0<r.length&&console.info(v.h+"."+v.f+"("+r[0]+(r[1]?", "+r[1]+")":""));else{for(var n=v.r,o=null,s=window.sf_||window.$sf?(g=(p=document.referrer).indexOf("//"),m=p.indexOf("/",g+2),w="",-1<g&&(m<0&&(m=p.length),w=p.substr(g+=2,m-g)),w):window.location.hostname,a=r[0],d=0;d<n.length&&!(a.length<10);d++){var h=S.CONSTANTS.MATCHING_STYLE_2;if(n[d].l&&0<n[d].l.length&&6===n[d].l[0].ot&&(h=S.CONSTANTS.MATCHING_STYLE_3,"r"===n[d].l[0].m&&(h=S.CONSTANTS.MATCHING_STYLE_4)),S._is_match(n[d].d,a,h,!0)&&!(0<=s.indexOf(n[d].d))){for(var c=!1,u=0;u<n[d].l.length;u++){var l=n[d].l[u],f=l.s?l.s:[];if(r[0]&&"string"==typeof r[0]&&(0===f.length&&2!=l.ot||S._is_match(f,a,S.CONSTANTS.MATCHING_STYLE_1,!1))){o="Found suspicious reference to: "+n[d].d+"?"+f.join("&"),console.error(o),S.errors.push(o),i=S._complete_blocking(a,v,d,u,e,window[v.h][v.f].arguments),r[0]=i.replaceWithHtml,c=!0;break}}if(c)break}}e&&c&&i.shouldBlock?window.location.replace("about:blank"):e||S.backupFunctions[v.h][v.f].apply(this,r)}}catch(t){console.error("ERROR",t),S.errors.push("ERROR: "+t),S.casprize(!0)}var p,g,m,w}},this.patch=function(t,e,i){i=i||this,"window"==t.h&&(toPatch=i.window[t.f]),toPatch=this.createPatchFunction(t,e,i),"window"==t.h?i.window[t.f]=toPatch:i.window[t.h][t.f]=toPatch},this.getSandboxingCode=function(){var e=!1,t=window.sf_||window.$sf,i=-1,r=!1,n=void 0!==this.isSandboxedSafeframe;if(t&&n)e=this.isSandboxedSafeframe,r=!0;else if(t&&!n)return i;try{document}catch(t){r=e=!0}if(!e)try{if(null!=window.frameElement){var o=window.frameElement.getAttribute("sandbox");e=o&&0<o.length,r=!0}window}catch(t){e=/(^|[\s\(\[@])sandbox(es|ed|ing|[\s\.,!\)\]@]|$)/.test(t.message.toLowerCase()),r=!0}return this.isForcedSandboxing?r=!(i=4):i=t?e?3:2:e?1:0,r?i:-1},h=this,window.addEventListener("error",function(t){try{if(!((d=t).message&&d.error&&f&&v()))return;var e=(t.error+""+(t.error.stack||"")).substr(0,500).trim();n=((r=t).error+""+(r.error.stack||"")).substr(0,500).trim(),o=v(),s=RegExp({chrome:"The current window does not have permission to navigate the target frame",firefox:"InvalidAccessError: A parameter or an operation is not supported by the underlying object",safari:"The operation is insecure."}[o],"gmi"),a=RegExp(/(d9\.flashtalking\.com\/)|(s0.2mdn\.net\/ads\/studio\/cached_libs\/modernizr)|(video)/,"gmi"),b(s,r.message)&&!b(a,n)&&(i=e,h._complete_blocking("\x3c!-- "+"Browser Detected: "+v()+" "+i+"--\x3e",{f:"write",h:"document",r:[{d:"",l:[{oi:1,ot:8,rs:1,isSb:1}]}]},0,0,!1,""))}catch(t){console.log("Confiant: Failed to listen to sandbox errors.")}var i,r,n,o,s,a,d}),this.init(),this.rules=this.getRules(),f)try{window[f.uniqueHash][f.tpIdentifier]["sb"]=this.getSandboxingCode(),3==this.devMode&&(window[f.uniqueHash][f.tpIdentifier].isPxlReq=!1)}catch(t){f&&window[f.uniqueHash]&&window[f.uniqueHash][f.tpIdentifier]&&(window[f.uniqueHash][f.tpIdentifier]["sb"]=-1)}};
    ...
    if (doc && id && !isAlreadyMonitored) {
      try {
        ...
        if (bid && bid.ad && !excludeBidder) {
          ...
          if (!confiantWrap(doc, bid, config.confiantCdn, config.propertyId, config.callback, serializedCasprLayer, config.devMode)) {
            doc.write(bid.ad);
            doc.close();
          }
